          ...
          <div className="flex items-start justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span
                  className={`mt-1 inline-flex items-center text-xs font-medium px-2 py-0.5 rounded-full border ${categoryBadge[project.category]}`}
                >
                  {project.category}
                </span>
              </div>
            ...
            <div className="flex items-center gap-1.5">
              <div
                className={`w-2 h-2 rounded-full ${statusColor[project.status]} animate-pulse`}
              />
