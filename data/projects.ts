...
export const projects: Project[] = [
    ...
    },
    {
        ...
        kpis: [
            { label: 'Service Requests Online', value: '100%', delta: 'no paper forms' },
            { label: 'Response Time', value: '3× Faster', delta: 'vs phone/walk-in' },
            { label: 'Community Reach', value: 'City-wide', delta: 'all departments' },
        ...
        architecture: [
            { layer: 'Citizen Portal', components: ['Service Request Forms', 'Status Tracker', 'Community Announcements', 'Local Resource Directory'], color: '#64748b' },
            { layer: 'Agency Tools', components: ['Request Management Board', 'Department Routing', 'Response Templates', 'Workload Dashboard'], color: '#475569' },
            { layer: 'Community Features', components: ['Public Feedback Forms', 'Event Calendar', 'Neighborhood Alerts', 'Polls & Surveys'], color: '#374151' },
            { layer: 'Admin Center', components: ['User Management', 'Analytics Reports', 'Content Management', 'Multi-Department Access'], color: '#1f2937' },
        ],
    },
    {
        ...
        kpis: [
            ...
            { label: 'Client Dashboard', value: 'Full', delta: 'CRM + project tracking' },
        ],
        techStack: [
            { name: 'React', category: 'Frontend', color: '#61dafb' },
            { name: 'Laravel', category: 'Backend', color: '#ef4444' },
        ...
        architecture: [
            { layer: 'Studio Website', components: ['Project Portfolio Gallery', 'Service Showcase', 'Consultation Request Form', 'Before & After Gallery'], color: '#b45309' },
            { layer: 'Client Experience', components: ['Design Mood Board', 'Project Progress Updates', 'Material Selections', 'Approval Sign-offs'], color: '#92400e' },
            { layer: 'Lead Management', components: ['Consultation Requests', 'Client Profiles', 'Quote Builder', 'Follow-Up Reminders'], color: '#78350f' },
            { layer: 'Studio Dashboard', components: ['Active Projects Board', 'Revenue Tracking', 'Team Assignments', 'Client Communications'], color: '#451a03' },
        ],
    },
    {
        id: 'press-bail-bonds',
        ...
        tagline: 'Full-Service Bail Bond Agency Platform with Posting Agent Dashboard',
        category: 'Legal SaaS',
        ...
        kpis: [
            ...
            { label: 'Case Turnaround', value: '5× Faster', delta: 'digital vs paper' },
            { label: 'Field Updates', value: 'Real-time', delta: 'live status board' },
            { label: 'Compliance Tracking', value: 'Automated', delta: 'court date alerts' },
        ],
        techStack: [
            { name: 'React', category: 'Frontend', color: '#61dafb' },
            { name: 'Laravel', category: 'Backend', color: '#ef4444' },
        ...
        architecture: [
            { layer: 'Client Website', components: ['Bond Application Form', 'Eligibility Checker', 'Online Payment', 'Document Upload'], color: '#b91c1c' },
            { layer: 'Posting Agent Dashboard', components: ['Active Bond Queue', 'Court Appearance Tracker', 'Field Status Updates', 'Document Repository'], color: '#991b1b' },
            { layer: 'Agent Commission Portal', components: ['Commission Calculator', 'Bond Performance Reports', 'Territory Management', 'Payout History'], color: '#7f1d1d' },
            { layer: 'Agency Dashboard', components: ['Case Overview Board', 'Revenue Analytics', 'Client History', 'Compliance Calendar'], color: '#450a0a' },
        ],
    },
    {
        id: 'global-llc',
        ...
        kpis: [
            { label: 'Formation Time', value: '48 hrs', delta: 'vs weeks by attorney' },
        ...
        architecture: [
            { layer: 'Formation Wizard', components: ['Business Name Search', 'State Selector', 'Guided Step-by-Step Form', 'Document Checklist'], color: '#4f46e5' },
            { layer: 'Document Center', components: ['Article of Organization', 'Registered Agent Assignment', 'Operating Agreement', 'EIN Application'], color: '#4338ca' },
            { layer: 'Client Portal', components: ['Formation Status Tracker', 'Certificate Storage', 'Annual Compliance Reminders', 'Amendment Requests'], color: '#3730a3' },
            { layer: 'Admin Dashboard', components: ['Order Management', 'State Filing Queue', 'Revenue Reports', 'Client Communications'], color: '#312e81' },
        ],
    },
];
